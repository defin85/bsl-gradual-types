#[cfg(test)]
mod tests {
    use bsl_backend::data::loaders::config_parser_xml::{ConfigParserXml, MetadataKind};
    use std::path::Path;
    ...
    fn test_composite_type_parsing() {
        ...
        let metadata = parser
            .parse_metadata_xml(test_file, &MetadataKind::Document)
