...
suite('LSP Custom Requests Test Suite', () => {
                        ...
                        traces: [
                            {
                                ...
                                followup_publish: {
                                    ...
                                    semantic_path: 'generic_pipeline',
    ...
    test('getCompletionTimeline should work via executeCommand', async function() {
        ...
        assert.strictEqual(result.response.version, 25);
        ...
        assert.strictEqual(
            result.response.traces[0].server_edge_details?.dispatch_to_request_context_wait_ms,
            0
        );
        assert.strictEqual(
    ...
    test('getDiagnosticsSaveTimeline should work via executeCommand', async function() {
        ...
        assert.strictEqual(result.response.traces[0].followup_publish?.semantic_path, 'generic_pipeline');
        assert.strictEqual(result.response.traces[0].followup_publish?.semantic_parse_source, 'salsa');
        assert.strictEqual(result.response.traces[0].followup_publish?.semantic_ir_source, 'salsa');
