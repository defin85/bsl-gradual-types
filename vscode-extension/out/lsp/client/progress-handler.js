...
exports.setupProgressHandler = void 0;
 ...
 */
function setupProgressHandler(client, outputChannel) {
...
exports.setupProgressHandler = setupProgressHandler;
/**
 * Обрабатывает начало прогресса
 */
function handleProgressBegin(key, value, states, outputChannel) {
    ...
    vscode.window.withProgress({
        ...
        (0, progress_1.setIndexingProgress)({
            isIndexing: true,
 ...
 */
function handleProgressReport(key, value, states, outputChannel) {
 ...
 */
function handleProgressEnd(key, value, states, outputChannel) {
...
function scheduleEnd(key, state, message, states, outputChannel) {
    if (!state.resolve) {
        state.pendingEndMessage = message;
        return;
    }
