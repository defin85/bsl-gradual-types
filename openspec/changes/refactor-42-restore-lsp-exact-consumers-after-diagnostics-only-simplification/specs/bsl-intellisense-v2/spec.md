...
- keep later hover/definition requests able to read or build the canonical exact artifact for the
  same current revision when that artifact is valid and buildable;
...
- **THEN** it reads or builds the canonical exact artifact for that revision
