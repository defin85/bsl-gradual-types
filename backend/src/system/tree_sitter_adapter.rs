...
use crate::parsing::bsl::ast::{CompilerDirective, Expression, ParseResult, Program, Statement};
...
impl TreeSitterAdapter {
    ...
    fn convert_function_definition(node: &Node, source: &str) -> Result<Statement, String> {
        ...
        let compiler_directive = Self::find_preceding_directive(node, source);
    ...
    fn find_preceding_directive(node: &Node, source: &str) -> Option<CompilerDirective> {
    ...
    fn parse_directive(text: &str) -> Option<CompilerDirective> {
