...
use bsl_shared::domain::analysis::type_checker::{TypeContext, TypeDiagnostic, DiagnosticSeverity};
    ...
    fn get_simple_type_name(type_res: &TypeResolution) -> String {
        match &type_res.result {
            ResolutionResult::Concrete(ConcreteType::Primitive(primitive)) => match primitive {
                bsl_shared::domain::types::PrimitiveType::String => "Строка".to_string(),
                bsl_shared::domain::types::PrimitiveType::Number => "Число".to_string(),
                bsl_shared::domain::types::PrimitiveType::Boolean => "Булево".to_string(),
                bsl_shared::domain::types::PrimitiveType::Date => "Дата".to_string(),
            },
            ResolutionResult::Concrete(ConcreteType::Platform(platform)) => platform.name.clone(),
...
mod tests {
    ...
    fn test_quick_fix_generator() {
        ...
        let suggested_type = bsl_shared::domain::standard_types::primitive_type(
            bsl_shared::domain::types::PrimitiveType::String,
        );
