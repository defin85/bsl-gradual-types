...
pub enum TypeErrorKind {
    ...
    /// Неопределенная функция или процедура (глобальный вызов)
    ///
    /// В 1С это компиляторная ошибка вида "Неопределенная процедура или функция".
    UndefinedFunctionOrProcedure {
