//! Graph Builder для анализа зависимостей типов

use crate::parsing::bsl::ast::{Expression, Parameter, Program, Statement};
use crate::parsing::bsl::visitor::AstVisitor;
use bsl_shared::domain::analysis::dependency_graph::{DependencyEdge, SourceLocation};
use bsl_shared::domain::analysis::{DependencyNode, DependencyType, Scope, TypeDependencyGraph};
