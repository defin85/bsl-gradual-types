...
- As of 2026-04-12, `didSave` follow-up keeps the existing zero-budget ready probe, but the bounded wait now runs only for `followup_ready_snapshot_task_state=in_flight_same_version`.
