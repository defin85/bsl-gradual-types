...
- [x] Минимальная полезность: hints типа `: <TypeName>` для локальных переменных (минимум: идентификатор слева в присваивании `X = ...;`); опционально — для return type функций.
