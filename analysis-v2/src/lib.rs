...
pub struct IrBuildProfile {
    ...
    pub semantic_facts_source_incomplete_member_access_recovery_ms: u128,
    pub semantic_facts_source_incomplete_member_access_recovery_count: u64,
    pub semantic_facts_syntax_incomplete_member_access_recovery_ms: u128,
    pub semantic_facts_syntax_incomplete_member_access_recovery_count: u64,
    pub semantic_facts_incomplete_call_target_recovery_ms: u128,
    pub semantic_facts_incomplete_call_target_recovery_count: u64,
