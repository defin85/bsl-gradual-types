...
/// Raw type data structure (simplified replacement for removed search module)
...
impl RawTypeData {
    pub fn new(name: String, full_name: String, category: String) -> Self {
        Self {
            name,
            full_name,
            category,
...
/// Simple replacements for removed analysis components (essential only)

/// Basic type checker context (simplified)
#[derive(Debug, Clone)]
pub struct TypeContext {
    pub variables: HashMap<String, TypeResolution>,
    pub functions: HashMap<String, FunctionSignature>,
    pub current_scope: String,
    pub globals: HashMap<String, TypeResolution>,
}
...
/// Basic diagnostic severity (simplified)
...
/// Basic type diagnostic (simplified)
#[derive(Debug, Clone)]
...
/// Basic function signature (simplified)
#[derive(Debug, Clone)]
...
/// Basic dependency graph types (simplified replacements)
#[derive(Debug, Clone)]
...
pub struct DependencyEdge {
    ...
    pub dep_type: DependencyType, // Alias for compatibility
...
/// Basic facet registry (simplified)
#[derive(Debug)]
...
impl FacetRegistry {
    ...
    pub fn register_facet(&mut self, name: String, value: String) {
...
/// Basic parameter info (simplified)
#[derive(Debug, Clone)]
pub struct ParameterInfo {
    pub name: String,
    pub parameter_type: Option<TypeResolution>,
    pub is_function: bool,
...
/// Basic union type manager (simplified)  
#[derive(Debug)]
pub struct UnionTypeManager;

impl UnionTypeManager {
    pub fn from_concrete_types(_types: Vec<TypeResolution>) -> TypeResolution {
