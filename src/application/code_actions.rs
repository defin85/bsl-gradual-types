    ...
    fn get_simple_type_name(type_res: &TypeResolution) -> String {
        match &type_res.result {
            ResolutionResult::Concrete(ConcreteType::Primitive(primitive)) => match primitive {
                crate::domain::types::PrimitiveType::String => "Строка".to_string(),
                crate::domain::types::PrimitiveType::Number => "Число".to_string(),
                crate::domain::types::PrimitiveType::Boolean => "Булево".to_string(),
                crate::domain::types::PrimitiveType::Date => "Дата".to_string(),
            },
            ResolutionResult::Concrete(ConcreteType::Platform(platform)) => platform.name.clone(),
...
mod tests {
    ...
    fn test_quick_fix_generator() {
        ...
        let suggested_type = crate::domain::standard_types::primitive_type(
            crate::domain::types::PrimitiveType::String,
        );
