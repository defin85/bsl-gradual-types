//! Стандартные типы BSL в domain слое

use crate::domain::types::{
    Certainty, ConcreteType, PlatformType, PrimitiveType, ResolutionResult, ResolutionSource,
    SpecialType, TypeResolution,
};

/// Создание примитивного типа
pub fn primitive_type(prim: PrimitiveType) -> TypeResolution {
    TypeResolution {
