...
- при более старом backend payload `v24`/`v23`/`v22`/`v21`/`v20`/`v19`/`v18`/`v17`/`v16`/`v15`/`v14`/`v13`/`v12`/`v11`/`v10`/`v9`/`v8`/`v7` extension деградирует явно и не выдумывает отсутствующие `v25`/`v24`/`v23`/`v22`/`v21`/`v20`/`v19`/`v18`/`v17`/`v16`/`v15`/`v14`/`v13`/`v12`/`v11`/`v10`/`v9`/`v8` поля;
