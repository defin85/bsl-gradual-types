...
- graceful degradation для backend payload `v18`/`v17`/`v16`/`v15`/`v14`/`v13`/`v12`/`v11`/`v10`/`v9`/`v8`/`v7` без выдумывания отсутствующих `v19`/`v18`/`v17`/`v16`/`v15`/`v14`/`v13`/`v12`/`v11`/`v10`/`v9`/`v8` полей;
