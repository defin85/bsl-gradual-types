...
mod tests {
    ...
    fn test_parse_catalog_attributes() {
        ...
        assert!(org_resolution.is_some(), "Должен найти справочник Организации");
    ...
    fn test_catalog_without_attributes() {
        ...
        let kontr_resolution = resolutions.iter()
            .find(|r| {
                if let ResolutionResult::Concrete(ConcreteType::Configuration(cfg)) = &r.result {
        ...
        assert!(kontr_resolution.is_some(), "Должен найти справочник Контрагенты");
