...
use anyhow::Result;
use bsl_gradual_types::documentation::search::fuzzy::{FuzzyMatchType, FuzzyMatcher};
...
fn main() -> Result<()> {
    ...
    println!(
        "Примерный объем памяти: {} байт",
        cache_stats.memory_estimate_bytes
    );
