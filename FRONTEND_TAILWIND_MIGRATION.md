...
**Milestone F2:** 📋 ПЛАНИРУЕТСЯ (миграция 14 компонентов)
...
- 🔄 **5 простых** компонентов (Week 1: 5-9 часов)
...
#### 📋 Week 1: Простые компоненты (5-9 часов)

- [ ] **1. navigation.rs** ⭐ (30 минут)
  - Сложность: 1/10
  - CSS для удаления: НЕТ (классы не существуют)
  - Риски: 🟢 Минимальные

- [ ] **2. metric_card.rs** ⭐ (45 минут)
  - Сложность: 1/10
  - CSS для удаления: строки 423-481 (59 строк)
  - Риски: 🟢 Минимальные

- [ ] **3. view_switcher.rs** ⭐⭐ (1.5 часа)
  - Сложность: 2/10
  - CSS для удаления: НЕТ (классы не существуют)
  - Особенность: 4 варианта компонента
  - Риски: 🟢 Низкие

- [ ] **4. search_bar.rs** ⭐⭐ (1.5 часа)
  - Сложность: 2/10
  - CSS для удаления: строки 369-386, 779-809 (~48 строк)
  - Особенность: 3 варианта компонента
  - Риски: 🟢 Низкие

- [ ] **5. pagination.rs** ⭐⭐⭐ (2 часа)
  - Сложность: 3/10
  - CSS для удаления: строки 1014-1250 (237 строк)
  - Риски: 🟢 Низкие
