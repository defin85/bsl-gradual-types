...
- [x] 1.2.1 Обновить `docs/guides/tooling-guide.md` на актуальные пути (SystemCoordinator/AnalysisEngine).
...
- [x] 2.1.1 `rg -n "backend/src/system/mod\\.rs|backend/src/application/type_system_service\\.rs" -S docs/guides/tooling-guide.md` возвращает пусто.
