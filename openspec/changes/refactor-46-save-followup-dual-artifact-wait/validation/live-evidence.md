...
- The preserved detached baseline regression passed and still routes the late save-followup family
  through `detached_ready_artifacts` rather than falling through to `shadow_state`.
...
- `followup_ready_snapshot_wait_probe=not_ready`
- `followup_ready_snapshot_bounded_wait_winner=detached_ready_artifacts`
- `followup_ready_snapshot_bounded_wait_elapsed_ms=1`
- `followup_ready_snapshot_timeout_leaf=null`
