...
pub(crate) struct TypeIndexBuildProfile {
    ...
    pub source_incomplete_member_access_recovery_ms: u128,
    pub source_incomplete_member_access_recovery_count: u64,
    pub syntax_incomplete_member_access_recovery_ms: u128,
    pub syntax_incomplete_member_access_recovery_count: u64,
    pub incomplete_call_target_recovery_ms: u128,
    pub incomplete_call_target_recovery_count: u64,
    pub total_ms: u128,
