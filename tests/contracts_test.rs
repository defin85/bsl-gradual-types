...
mod tests {
    ...
    fn test_generate_contract_for_unknown_type() {
        ...
        assert!(
            contract.is_some(),
            "Должен сгенерировать контракт для Unknown типа"
        );
    ...
    fn test_generate_contract_for_low_confidence() {
        ...
        assert!(
            contract.is_some(),
            "Должен сгенерировать контракт для типа с низкой уверенностью"
        );
    ...
    fn test_no_contract_for_known_type() {
        ...
        assert!(
            contract.is_none(),
            "Не должен генерировать контракт для Known типа"
        );
    }
    ...
    fn test_generate_union_contract() {
        ...
        assert!(
            contract.is_some(),
            "Должен сгенерировать контракт для Union типа"
        );
