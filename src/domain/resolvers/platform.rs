...
impl PlatformTypeResolver {
    ...
    fn create_catalog_resolution(&self, name: &str) -> TypeResolution {
        ...
        TypeResolution {
            ...
            result: ResolutionResult::Concrete(ConcreteType::Configuration(
                crate::domain::types::ConfigurationType {
                    kind: crate::domain::types::MetadataKind::Catalog,
                    name: name.to_string(),
    ...
    fn create_document_resolution(&self, name: &str) -> TypeResolution {
        ...
        TypeResolution {
            ...
            result: ResolutionResult::Concrete(ConcreteType::Configuration(
                crate::domain::types::ConfigurationType {
                    kind: crate::domain::types::MetadataKind::Document,
                    name: name.to_string(),
                    attributes: vec![],
    ...
    fn create_enum_resolution(&self, name: &str) -> TypeResolution {
        ...
        TypeResolution {
            ...
            result: ResolutionResult::Concrete(ConcreteType::Configuration(
                crate::domain::types::ConfigurationType {
                    kind: crate::domain::types::MetadataKind::Enum,
                    name: name.to_string(),
                    attributes: vec![],
                    tabular_sections: vec![],
                },
