...
pub(super) fn resolve_receiver_types_from_expression(
    analysis: Option<&CompletionAnalysisContext<'_>>,
    file_content: &str,
    line: u32,
    column: u32,
...
pub(super) fn resolve_identifier_receiver_types(
    analysis: Option<&CompletionAnalysisContext<'_>>,
    file_content: &str,
    line: u32,
    column: u32,
...
pub(super) fn resolve_global_function_return_types(
    resolver: Option<&TypeResolver>,
    metadata_lookup: &TypeMetadataLookup,
    function_name: &str,
) -> Vec<TypeResolution> {
...
pub(super) fn resolve_index_access_element_type(
    resolver: Option<&TypeResolver>,
    metadata_lookup: &TypeMetadataLookup,
    owner: &TypeResolution,
) -> Option<TypeResolution> {
...
pub(super) fn dedup_resolutions(resolutions: Vec<TypeResolution>) -> Vec<TypeResolution> {
