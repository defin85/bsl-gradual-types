...
- при более старом backend payload `v11`/`v10`/`v9`/`v8`/`v7` extension деградирует явно и не выдумывает отсутствующие `v12`/`v11`/`v10`/`v9`/`v8` поля;
