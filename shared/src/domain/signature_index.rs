...
impl SignatureIndex {
    ...
    pub fn extract_base_facet_type(type_name: &str) -> Option<&str> {
        super::facet_utils::extract_base_facet_type(type_name)
    }
    ...
    pub fn substitute_type_name(return_type: &str, actual_name: &str) -> String {
        ...
        if let Some(dot_pos) = return_type.find('.') {
            ...
            if super::facet_utils::is_known_facet_prefix(prefix) {
        ...
        if super::facet_utils::is_known_facet_prefix(return_type) {
