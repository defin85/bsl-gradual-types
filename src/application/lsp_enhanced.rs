...
impl EnhancedTypeAnalyzer {
    ...
    fn format_certainty(certainty: &crate::domain::types::Certainty) -> String {
        match certainty {
            crate::domain::types::Certainty::Known => "100%".to_string(),
            crate::domain::types::Certainty::Inferred(conf) => {
                format!("{}%", (conf * 100.0) as u32)
            }
            crate::domain::types::Certainty::Unknown => "неизвестно".to_string(),
        }
    }
...
impl DiagnosticsConverter {
    ...
    fn convert_severity(
        severity: &crate::domain::analysis::type_checker::DiagnosticSeverity,
    ) -> DiagnosticSeverity {
        match severity {
            crate::domain::analysis::type_checker::DiagnosticSeverity::Error => {
                DiagnosticSeverity::ERROR
            }
            crate::domain::analysis::type_checker::DiagnosticSeverity::Warning => {
                DiagnosticSeverity::WARNING
            }
            crate::domain::analysis::type_checker::DiagnosticSeverity::Info => {
                DiagnosticSeverity::INFORMATION
            }
            crate::domain::analysis::type_checker::DiagnosticSeverity::Hint => {
