...
use crate::domain::analysis::dependency_graph::Scope;
...
impl InterproceduralAnalyzer {
    ...
    fn analyze_function_body(&self, body: &[Statement]) -> TypeResolution {
        ...
        if return_types.is_empty() {
            ...
            crate::domain::analysis::union_types::UnionTypeManager::create_union(return_types)
        }
    }
        ...
        match statement {
            ...
            Statement::If {
                ...
                if types.is_empty() {
                    ...
                    Some(
                        crate::domain::analysis::union_types::UnionTypeManager::create_union(types),
                    )
                }
            }
