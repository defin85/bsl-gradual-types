...
| --- | --- | --- | --- | --- |
| Governance | `check-openspec-change-governance.py` | Gate exits `0` and validates `change_criticality`, `test_first_evidence`, ADR/doc-first artifacts | Missing/invalid governance artifact or invalid evidence refs | `openspec/changes/add-performance-first-ai-engineering-guardrails/validation/review-ownership-signoff.md` |
